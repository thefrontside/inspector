import { createChannel, createContext, lift, resource, type Subscription, withResolvers, type Operation } from "effection";
...
export const player = createImplementation(protocol, function*() {
  ...
  return {
    ...
    watchPlayerState: () => resource(function*(provide) {
